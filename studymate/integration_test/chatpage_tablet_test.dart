...
void main() {
  ...
  testWidgets('Clicking on message - messages - tablet', (tester) async {
    //setup
    app.main();
    //do
  ...
  testWidgets('Entering text on searcbar - messages - tablet',
      (tester) async {
    //setup
    app.main();
    //do
  ...
  testWidgets(
      'Entering text and deleting text on searcbar - messages - tablet',
      (tester) async {
    //setup
    app.main();
    //do
  ...
  testWidgets('Entering text - chat - messages - tablet', (tester) async {
    //setup
    app.main();
    //do
    await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    final textFieldFinder = find.byKey(Key('messageTextField'));
    expect(textFieldFinder, findsOneWidget);
  ...
  testWidgets('Sending message - chat - messages - tablet', (tester) async {
    //setup
    app.main();
    //do
    await tester.pumpAndSettle(const Duration(seconds: 5));
    ...
    final testText = 'Hello, World!tablet';
    await tester.enterText(textFieldFinder, testText);
    await tester.pumpAndSettle(const Duration(seconds: 2));
    ...
    expect(find.text('Hello, World!tablet'), findsOneWidget);
  });
  testWidgets('Sending more messages - chat - messages - tablet',
      (tester) async {
    //setup
    app.main();
    //do
    ...
    final testText = 'Hello, World! Two time tablet';
    await tester.enterText(textFieldFinder, testText);
    await tester.pumpAndSettle(const Duration(seconds: 2));
    await tester.tap(find.byIcon(Icons.send));
    await tester.pumpAndSettle(const Duration(seconds: 2));
    ...
    expect(find.text('Hello, World! Two time tablet'), findsNWidgets(2));
  });
  testWidgets('Clicking attach - chat - messages - tablet', (tester) async {
    //setup
    app.main();
    //do
    await tester.pumpAndSettle(const Duration(seconds: 5));
  ...
  testWidgets('Sending current position - chat - messages - tablet',
      (tester) async {
    //setup
    app.main();
    //do
